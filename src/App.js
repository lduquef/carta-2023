...
function App() {
  return (<div className='flex flex-col  items-center'>
    <div className="px-2 shadow-2xl   text-center bg-gradient-to-br hover:bg-gradient-to-tr hover:backdrop-blur-sm from-violet-500 to-purple-400  md:w-128 sm:w-90 rounded-3xl ">
      <p className=' hover:animate-pulse min-w-min  mx-20 Whitelisa text-9xl'>
      Estefín
      </p>
      
    </div>
    <p className='NotoSansKorean -z-10  text-purple-200 text-6xl h-max -mx-20 -my-40'>
